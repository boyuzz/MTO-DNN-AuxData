...
class OxfordPets(data.Dataset):
	"""`OxfordPets <http://www.robots.ox.ac.uk/~vgg/data/flowers/102/>`_ Dataset.
	...
	"""
	data_url = "http://www.robots.ox.ac.uk/~vgg/data/pets/data/images.tar.gz"
	label_url = "http://www.robots.ox.ac.uk/~vgg/data/pets/data/annotations.tar.gz"

	data_filename = "images.tar.gz"
	label_filename = "annotations.tar.gz"

	data_md5 = '08a0e08f5962d57425064f5cfc777a14'
	label_md5 = '0f4c89c7bc425b59a79db14fa78521ea'
	...
	def _check_integrity(self):
		root = self.root
		check_list = [(self.data_filename, self.data_md5), (self.label_filename, self.label_md5)]
